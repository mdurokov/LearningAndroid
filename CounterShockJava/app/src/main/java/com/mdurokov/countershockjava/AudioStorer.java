...
public class AudioStorer {
    ...
    public List<AudioModel> getAllAudios(){
        ...
        audios.add(new AudioModel(0, "behind_you", "Behind you!", true));
        audios.add(new AudioModel(1, "see_you", "I see you!", true));
        audios.add(new AudioModel(2, "watching_you", "Watching you!", true));
